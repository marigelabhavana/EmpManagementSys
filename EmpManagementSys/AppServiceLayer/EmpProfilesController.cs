...
namespace EmpManagementSys.Controllers
{
    ...
    public class EmpProfilesController : ControllerBase
    {
        ...
        public EmpProfilesController(EMSContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'EmpManagementSysContext.EmpProfile'  is null.");
          }
